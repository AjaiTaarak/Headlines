...
public class Adapter_homelocal extends RecyclerView.Adapter<Adapter_homelocal.SimpleViewHolder>{
    ...
    public Adapter_homelocal(Context applicationContext, List<Model_Article> model_headlines) {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_toplocal, parent, false);
